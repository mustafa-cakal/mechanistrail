...
const galleryPhotos = [
  ...
  { src: "aydınlatma-direk2.png", caption: "Aydınlatma Direği Tasarımı — Mechanistrail" },
];
...
const projects = {
  tr: [
    ...
    { title:"Aydınlatma Direği Tasarımı", desc:"Belediyeler ve şirketler için kuruma özel aydınlatma direği tasarımı — özgün form, yapısal analiz ve marka kimliğiyle uyumlu çözümler.", img:"aydınlatma-direk2.png", icon:"ti-bulb", iconColor:"#f59e0b", iconBg:"rgba(245,158,11,0.1)", tags:["Kentsel Tasarım","Belediye","Kurumsal"], link:"aydinlatma-diregi.html" },
  ],
  en: [
    ...
    { title:"Lighting Pole Design", desc:"Custom lighting pole design for municipalities and companies — unique form, structural analysis and brand-aligned solutions.", img:"aydınlatma-direk2.png", icon:"ti-bulb", iconColor:"#f59e0b", iconBg:"rgba(245,158,11,0.1)", tags:["Urban Design","Municipality","Corporate"], link:"aydinlatma-diregi.html" },
  ]
};
