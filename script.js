...
/* =============================================
   ...
   ============================================= */
const galleryPhotos = [
  { src: "lokomotif_1.webp", caption: "Mechanistrail — Mühendislik Projelerimizden" },
  { src: "lokomotif_2.webp", caption: "Mechanistrail — Mühendislik Projelerimizden" },
  { src: "lokomotif_3.webp", caption: "Mechanistrail — Mühendislik Projelerimizden" },
  { src: "lokomotif_4.webp", caption: "Mechanistrail — Mühendislik Projelerimizden" },
  { src: "lokomotif_5.webp", caption: "Mechanistrail — Mühendislik Projelerimizden" },
  { src: "lokomotif_6.webp", caption: "Mechanistrail — Mühendislik Projelerimizden" },
  { src: "laptop-standi-4.webp", caption: "Katlanabilir Laptop Standı — Mechanistrail" },
  { src: "ananas_render1.webp", caption: "Ananas Soyma Makinası — Mechanistrail" },
  { src: "duvar-yazicisi-1.webp", caption: "Duvar Yazıcısı — Mechanistrail" },
  { src: "nohut_ayıklama1.webp", caption: "Nohut Ayıklama Makinası — Mechanistrail" },
  { src: "ipek_gerdirme1.webp", caption: "İpek Gerdirme Makinası — Mechanistrail" },
  { src: "aydınlatma-direk2.webp", caption: "Aydınlatma Direği Tasarımı — Mechanistrail" },
];
...
const projects = {
  tr: [
    { title:"Endüstriyel Konveyör Sistemi", desc:"Mekanik tasarım, PLC yazılımı ve termal analiz.", img:"lokomotif_1.webp", icon:"ti-robot", iconColor:"#378ADD", iconBg:"rgba(24,95,165,0.1)", tags:["Mekanik","PLC","Termal"], link:"konveyor-sistemi.html" },
    { title:"HVAC Akış Optimizasyonu", desc:"CFD simülasyonu ile enerji verimliliği %23 artırıldı.", img:"lokomotif_2.webp", icon:"ti-wind", iconColor:"#EF9F27", iconBg:"rgba(186,117,23,0.1)", tags:["CFD","HVAC","Akış"], link:"hvac-akis-optimizasyonu.html" },
    { title:"Akıllı Sensör PCB Kartı", desc:"Çok katmanlı PCB tasarımı ve gömülü yazılım.", img:"lokomotif_3.webp", icon:"ti-cpu", iconColor:"#5DCAA5", iconBg:"rgba(29,158,117,0.1)", tags:["PCB","IoT","Yazılım"], link:"akilli-sensor-pcb.html" },
    { title:"Soğutma Termal Analizi", desc:"Yüksek güçlü elektronik soğutma sistemi simülasyonu.", img:"lokomotif_4.webp", icon:"ti-ripple", iconColor:"#AFA9EC", iconBg:"rgba(127,119,221,0.1)", tags:["Termal","FEA","Soğutma"], link:"sogutma-termal-analiz.html" },
    { title:"Özel Makine Tasarımı", desc:"Kinematik analiz, yapısal hesap ve prototip üretimi.", img:"lokomotif_5.webp", icon:"ti-3d-cube-sphere", iconColor:"#378ADD", iconBg:"rgba(24,95,165,0.1)", tags:["Mekanik","Kinematik","Prototip"], link:"ozel-makine-tasarimi.html" },
    { title:"Motor Kontrol Sistemi", desc:"Servo motor sürücü kartı ve kontrol yazılımı.", img:"lokomotif_6.webp", icon:"ti-engine", iconColor:"#5DCAA5", iconBg:"rgba(29,158,117,0.1)", tags:["Elektronik","Kontrol","Yazılım"], link:"motor-kontrol-sistemi.html" },
    { title:"Katlanabilir Laptop Standı", desc:"Ergonomik, taşınabilir alüminyum laptop standı — mekanik tasarım, kinematik analiz ve prototip üretimi.", img:"laptop-standi-1.webp", icon:"ti-device-laptop", iconColor:"#378ADD", iconBg:"rgba(24,95,165,0.1)", tags:["Mekanik Tasarım","Prototip","Ürün Geliştirme"], link:"laptop-standi.html" },
    { title:"Ananas Soyma Makinası", desc:"Gıda endüstrisine yönelik endüstriyel ananas soyma makinası — mekanik tasarım, kinematik analiz ve prototip üretimi.", img:"ananas_render1.webp", icon:"ti-tool", iconColor:"#97C459", iconBg:"rgba(99,153,34,0.1)", tags:["Mekanik","Gıda Makinesi","Prototip"], link:"ananas-soyma-makinasi.html" },
    { title:"Duvar Yazıcısı", desc:"CNC kontrollü duvar boyama makinası — X-Y-Z eksen hareketi, alüminyum profil yapı ve komple prototip üretimi.", img:"duvar yazıcısı/DUVAR BOYAMA MONTAJI.webp", icon:"ti-printer", iconColor:"#60a5fa", iconBg:"rgba(59,130,246,0.1)", tags:["CNC","Mekanik Tasarım","Prototip"], link:"duvar-yazicisi.html" },
    { title:"Nohut Ayıklama Makinası", desc:"Gıda endüstrisine yönelik endüstriyel nohut ayıklama makinası — mekanik tasarım, titreşim analizi ve prototip üretimi.", img:"nohut_ayıklama1.webp", icon:"ti-grain", iconColor:"#EF9F27", iconBg:"rgba(186,117,23,0.1)", tags:["Mekanik","Gıda Makinesi","Titreşim"], link:"nohut-ayiklama-makinasi.html" },
    { title:"İpek Gerdirme Makinası", desc:"Değirmen eleği üretiminde kullanılan ipek gerdirme makinası — ipek fileyi ahşap çıtalara özel yapıştırıcılarla gergin şekilde sabitleyen mekanik sistem.", img:"ipek_gerdirme1.webp", icon:"ti-needle", iconColor:"#a78bfa", iconBg:"rgba(167,139,250,0.1)", tags:["Mekanik","Elek Makinesi","Değirmen"], link:"ipek-gerdirme-makinasi.html" },
    { title:"Aydınlatma Direği Tasarımı", desc:"Belediyeler ve şirketler için kuruma özel aydınlatma direği tasarımı — özgün form, yapısal analiz ve marka kimliğiyle uyumlu çözümler.", img:"aydınlatma-direk2.webp", icon:"ti-bulb", iconColor:"#f59e0b", iconBg:"rgba(245,158,11,0.1)", tags:["Kentsel Tasarım","Belediye","Kurumsal"], link:"aydinlatma-diregi.html" },
  ],
  en: [
    { title:"Industrial Conveyor System", desc:"Mechanical design, PLC software and thermal analysis.", img:"lokomotif_1.webp", icon:"ti-robot", iconColor:"#378ADD", iconBg:"rgba(24,95,165,0.1)", tags:["Mechanical","PLC","Thermal"], link:"konveyor-sistemi.html" },
    { title:"HVAC Flow Optimization", desc:"Energy efficiency increased by 23% with CFD simulation.", img:"lokomotif_2.webp", icon:"ti-wind", iconColor:"#EF9F27", iconBg:"rgba(186,117,23,0.1)", tags:["CFD","HVAC","Flow"], link:"hvac-akis-optimizasyonu.html" },
    { title:"Smart Sensor PCB Board", desc:"Multi-layer PCB design and embedded software.", img:"lokomotif_3.webp", icon:"ti-cpu", iconColor:"#5DCAA5", iconBg:"rgba(29,158,117,0.1)", tags:["PCB","IoT","Software"], link:"akilli-sensor-pcb.html" },
    { title:"Cooling Thermal Analysis", desc:"High-power electronics cooling system simulation.", img:"lokomotif_4.webp", icon:"ti-ripple", iconColor:"#AFA9EC", iconBg:"rgba(127,119,221,0.1)", tags:["Thermal","FEA","Cooling"], link:"sogutma-termal-analiz.html" },
    { title:"Custom Machine Design", desc:"Kinematic analysis, structural calculation and prototype manufacturing.", img:"lokomotif_5.webp", icon:"ti-3d-cube-sphere", iconColor:"#378ADD", iconBg:"rgba(24,95,165,0.1)", tags:["Mechanical","Kinematics","Prototype"], link:"ozel-makine-tasarimi.html" },
    { title:"Motor Control System", desc:"Servo motor driver board and control software.", img:"lokomotif_6.webp", icon:"ti-engine", iconColor:"#5DCAA5", iconBg:"rgba(29,158,117,0.1)", tags:["Electronics","Control","Software"], link:"motor-kontrol-sistemi.html" },
    { title:"Foldable Laptop Stand", desc:"Ergonomic, portable aluminium laptop stand — mechanical design, kinematic analysis and prototype manufacturing.", img:"laptop-standi-1.webp", icon:"ti-device-laptop", iconColor:"#378ADD", iconBg:"rgba(24,95,165,0.1)", tags:["Mechanical Design","Prototype","Product Development"], link:"laptop-standi.html" },
    { title:"Pineapple Peeling Machine", desc:"Industrial pineapple peeling machine for the food industry — mechanical design, kinematic analysis and prototype manufacturing.", img:"ananas_render1.webp", icon:"ti-tool", iconColor:"#97C459", iconBg:"rgba(99,153,34,0.1)", tags:["Mechanical","Food Machine","Prototype"], link:"ananas-soyma-makinasi.html" },
    { title:"Wall Printer", desc:"CNC-controlled wall painting machine — X-Y-Z axis motion, aluminium profile structure and complete prototype manufacturing.", img:"duvar yazıcısı/DUVAR BOYAMA MONTAJI.webp", icon:"ti-printer", iconColor:"#60a5fa", iconBg:"rgba(59,130,246,0.1)", tags:["CNC","Mechanical Design","Prototype"], link:"duvar-yazicisi.html" },
    { title:"Chickpea Sorting Machine", desc:"Industrial chickpea sorting machine for the food industry — mechanical design, vibration analysis and prototype manufacturing.", img:"nohut_ayıklama1.webp", icon:"ti-grain", iconColor:"#EF9F27", iconBg:"rgba(186,117,23,0.1)", tags:["Mechanical","Food Machine","Vibration"], link:"nohut-ayiklama-makinasi.html" },
    { title:"Silk Stretching Machine", desc:"Silk stretching machine for mill sieve production — stretches silk mesh onto wooden frames using special adhesives for uniform tension.", img:"ipek_gerdirme1.webp", icon:"ti-needle", iconColor:"#a78bfa", iconBg:"rgba(167,139,250,0.1)", tags:["Mechanical","Sieve Machine","Mill"], link:"ipek-gerdirme-makinasi.html" },
    { title:"Lighting Pole Design", desc:"Custom lighting pole design for municipalities and companies — unique form, structural analysis and brand-aligned solutions.", img:"aydınlatma-direk2.webp", icon:"ti-bulb", iconColor:"#f59e0b", iconBg:"rgba(245,158,11,0.1)", tags:["Urban Design","Municipality","Corporate"], link:"aydinlatma-diregi.html" },
  ]
};
